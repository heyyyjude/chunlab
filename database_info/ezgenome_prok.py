...
class Contig(Base):
    ...
    project_uid = Column(Integer, primary_key=True, nullable=False, index=True)
    ...
    acc_ver = Column(String(100), primary_key=True, nullable=False, index=True)
...
class Project(Base):
    ...
    strain_property = Column(String(100), server_default=text("''"))
    strain_name = Column(String(100), server_default=text("''"))
    strain_type = Column(Integer, nullable=False, index=True, server_default=text("'-1'"))
    superkingdom = Column(String(20), server_default=text("''"))
    taxonomy = Column(String(200), server_default=text("''"))
...
class ProjectCopy(Base):
    __tablename__ = 'project_copy'
...
class ProjectStrain(Base):
    __tablename__ = 'project_strain'

    ez_prok_acc = Column(String(50), primary_key=True)
    strain_name_prok = Column(String(50))
    strain_name_leb = Column(String(50))
